...
=======
>>>>>>> a10f89a... ASoC: msm: Add support to enable audio post processing in DSP
};
...
static void populate_codec_list(struct msm_compr_audio *prtd)
{
	...
	prtd->compr_cap.codecs[8] = SND_AUDIOCODEC_VORBIS;
	prtd->compr_cap.codecs[9] = SND_AUDIOCODEC_ALAC;
	prtd->compr_cap.codecs[10] = SND_AUDIOCODEC_APE;
}
